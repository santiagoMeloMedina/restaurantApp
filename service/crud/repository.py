...
class RestaurantRepo:
    ...
    def get_restaurant_by_id(self, id: str) -> Optional[model.Restaurant]:
        ...
        return model.Restaurant.parse_obj(response.get('Item')) if 'Item' in response else None
    ...
    def scan_public_restaurants(self, limit: int, offset: int) -> List[model.Restaurant]:
