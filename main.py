...
from service.crud import create as create_restaurant, update as update_restaurant, get_private as get_private_restaurants, get_public as get_public_restaurants, get_by_id as get_single_restaurant
...
@app.route("/restaurant/get/single", methods=["POST"])
def get_by_id():
    event = {"body": request.get_json(), "headers": request.headers}
    return jsonify(get_single_restaurant.handler(event, {}))
